%{
class GmsecBinaryData
{
public:
    GmsecBinaryData() : data(0), size(0) {}

    GmsecBinaryData(unsigned char* d, int s) : data(d), size(s) {}
...
%pragma(csharp) imclasscode=%{
    internal class SWIGByteArrayHelper : System.MarshalByRefObject {
        ...
        public static extern void SWIGRegisterByteArrayCallback_$module(SWIGByteArrayDelegate bytearrayDelegate);
...
%typemap(out) GmsecBinaryData %{ SWIG_csharp_bytearray_callback($1.data, $1.size); %}

%typemap(csout) GmsecBinaryData {
