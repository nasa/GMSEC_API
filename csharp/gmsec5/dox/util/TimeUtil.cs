...
public class TimeUtil : global::System.IDisposable {
  ...
  /// <summary>Converts the given time string into a %GMSEC_TimeSpec object.</summary>
  ///
  /// <param name="timeString">A time string in the format of YYYY-DDD-HH-MM-SS[.sss]</param>
  ///
  /// <returns>A GMSEC_TimeSpec object that contains the converted time</returns>
  ///
  /// <exception cref="GmsecException">Thrown if an invalid time string is given</exception>
  public static GMSEC_TimeSpec ConvertTimeString(string timeString) {
  }

  /// <summary>Converts the given time string into a double value representing the number of seconds since Jan 1, 1970.</summary>
  ///
  /// <param name="timeString">A time string in the format of YYYY-DDD-HH-MM-SS[.sss]</param>
  ///
  ...
  ///
  /// <exception cref="GmsecException">Thrown if an invalid time string is given</exception>
  public static double ConvertTimeString_s(string timeString) {
  }
