...
/// </summary>
///
/// <seealso cref="Connection,RegisterEventCallback(Connection, Event, EventCallback)"/>
...
public class EventCallback : global::System.IDisposable {
  ...
  ///
  /// <b>DO NOT STORE</b> the Status object for use beyond the scope of the callback. If necessary, make a
  ...
  public virtual void OnEvent(Connection conn, Status status, Connection.Event event) {
  }
