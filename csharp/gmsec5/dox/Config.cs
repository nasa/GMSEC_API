...
public class Config : global::System.IDisposable {
  ...
  /// <seealso cref="ToXML()" />
  /// <seealso cref="ToJSON()" />
  public Config(string data, DataType type) {
  }
  ...
  ///
  /// <exception cref="GmsecException">Thrown if either the name or value are null, or are empty strings.</exception>
  ...
  ///
  /// <exception cref="GmsecException">Thrown if the name is null or an empty string.</exception>
  ...
  ///
  /// <exception cref="GmsecException">Thrown if null or empty string is given for the name, name is not found, or value cannot be converted to a boolean.</exception>
  ...
  /// If the field is not set or does not conform to a number, then an exception
  /// is thrown.</summary>
  ///
  /// <param name="name">name of value to get</param>
  ///
  /// <returns>value of named item</returns>
  ///
  /// <exception cref="GmsecException">Thrown if null or empty string is given for the name, name is not found, or value cannot be converted to an integer.</exception>
  ...
  /// <returns>value of named item</returns>
  ///
  /// <exception cref="GmsecException">Thrown if null or empty string is given for the name, name is not found, or value cannot be converted to a double.</exception>
  ...
  /// <summary>This method clears all values from the %Config object.</summary>
  public void Clear() {
  }

  /// <summary>Merges the given %Config with the existing %Config object.</summary>
  ///
  /// <param name="other">%Config object from which to read name/value pairs.</param>
  /// <param name="overwriteExisting">Indicates whether to overwrite existing name/value pairs within the working %Config object.</param>
  ...
  ///
  /// <exception cref="GmsecException">Thrown if a malformed XML, or null, string is given.</exception>
  public void FromXML(string xml) {
  }

  /// <summary>Attempts to open the given file and use the contents to create a Config object.</summary>
  ///
  /// <param name="filename">The configuration file to open.</param>
  /// <param name="configName">The configuration file to open.</param>
  ///
  /// <returns>A Config object.</returns>
  ///
  /// <exception cref="GmsecException">Thrown if the file name is null, or consists of an empty string.</exception>
  /// <exception cref="GmsecException">Thrown if the file cannot be opened.</exception>
  /// <exception cref="GmsecException">Thrown if the file does not contain a valid configuration construct.</exception>
  /// <exception cref="GmsecException">Thrown if the file does not contain the named configuration construct.</exception>
  public static Config GetFromFile(string filename, string configName) {
  }
