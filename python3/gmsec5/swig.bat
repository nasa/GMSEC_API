...
REM This script is invoked as a Custom Build Tool for libgmsec_python3.i
REM
REM To view how this script is called, right-click on libgmsec_python3.i, select Custom Build Tool->General,
...
echo "%SWIG_HOME%\swig.exe" -DSWIG_BINDING -DCHAR_BIT=8 -c++ -python -threads -I..\..\framework\include -I"!_VCInstallDir!include" -I"!INCLUDE!" "!_InputFile!"
"%SWIG_HOME%\swig.exe" -DSWIG_BINDING -DCHAR_BIT=8 -c++ -python -threads -I..\..\framework\include -I"!_VCInstallDir!include" -I"!INCLUDE!" "!_InputFile!"
