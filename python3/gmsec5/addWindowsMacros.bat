...
REM
perl -i.bak -pe "s/onMessage/CALL_TYPE onMessage/g" interfaces\libgmsec_python3_wrap.h
perl -i.bak -pe "s/onReply/CALL_TYPE onReply/g" interfaces\libgmsec_python3_wrap.h
perl -i.bak -pe "s/validateMessage/CALL_TYPE validateMessage/g" interfaces\libgmsec_python3_wrap.h
perl -i.bak -pe "s/onEvent/ CALL_TYPE onEvent/g" interfaces\libgmsec_python3_wrap.h
