...
%feature("docstring") gmsec::api5::EventCallback "
...
%feature("docstring") gmsec::api5::EventCallback::onEvent "

    on_event(self, conn: Connection, status: Status, event: Connection::Event)
