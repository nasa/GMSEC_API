...
%feature("docstring") gmsec::api::Message "
    ...
    The Message object is a container for GMSEC Messages. The methods
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the subject is NULL or contains an
        empty-string.
    ...
    Copy constructor - initializes the message instance using the
    other given Message.
...
%feature("docstring") gmsec::api::Message::getStringField "
    ...
    Returns a reference to the StringField associated with the named
    field.
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT a StringField or
    cannot be found.
";
...
%feature("docstring") gmsec::api::Message::getI16Field "
    ...
    Exception
    ---------
    A GmsecError is thrown if the named field is NOT an I16Field or
    cannot be found.
";
...
%feature("docstring") gmsec::api::Message::addField "
    ...
    Therefore the field is owned by the client program and can be
    reused.
    The client program must also clean up that field when no longer
    needed.
    ...
    Returns
    -------
    Returns true if the Field is replacing one with the same name;
    false otherwise.
...
%feature("docstring") gmsec::api::Message::getU32Field "
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT an U32Field or
    cannot be found.
";
...
%feature("docstring") gmsec::api::Message::getBinaryField "
    ...
    Returns a reference to the BinaryField associated with the named
    field.
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT a BinaryField or
    cannot be found.
";
...
%feature("docstring") gmsec::api::Message::getI64Field "
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT an I64Field or
    cannot be found.
";
...
%feature("docstring") gmsec::api::Message::getCharField "
    ...
    Returns a reference to the CharField associated with the named
    field.
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT a CharField or
    cannot be found.
";
...
%feature("docstring") gmsec::api::Message::getF32Field "
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT an F32Field or
    cannot be found.
";
...
%feature("docstring") gmsec::api::Message::getSubject "
    ...
    This function get the subject this message will be/was published
    upon.
...
%feature("docstring") gmsec::api::Message::getConfig "
    ...
    This function gets a copy of the Configuration associated with the
    message.
...
%feature("docstring") gmsec::api::Message::getI32Field "
    ...
    This function will return the named Field object contained within
    the Message object, if it exists. Otherwise a NULL pointer is
    returned.

    Example:
    field = msg.getField(\"BOOL_FIELD\")

    if field.getType() == libgmsec_python3.Field.BOOL_TYPE:
...
%feature("docstring") gmsec::api::Message::getI8Field "
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT an I8Field or
    cannot be found.
";
...
%feature("docstring") gmsec::api::Message::getU64Field "
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT an U64Field or
    cannot be found.
";

%feature("docstring") gmsec::api::Message::getFieldIterator "

    getFieldIterator(self, selector=libgmsec_python3.MessageFieldIterator.ALL_FIELDS) -> MessageFieldIterator
    ...
    Field objects stored within the Message.
    The iterator is reset each time getFieldIterator() is called.
    The iterator itself is destroyed when the Message object is
    destroyed.

    Note: Only one MessageFieldIterator object is associated with a
    Message object; multiple calls to getFieldIterator() will return a
    reference to the same MessageFieldIterator object. Each call will
    reset the iterator.
...
%feature("docstring") gmsec::api::Message::getBooleanField "
    ...
    Returns a reference to the BooleanField associated with the named
    field.
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT a BooleanField or
        cannot be found.
";
...
%feature("docstring") gmsec::api::Message::getU8Field "
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT an U8Field or
        cannot be found.
";
...
%feature("docstring") gmsec::api::Message::getStringValue "
    ...
    ----------
    A GmsecError is thrown if the field cannot be found, or if it
        cannot successfully be converted to a string value.
";
...
%feature("docstring") gmsec::api::Message::getU16Field "
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the named field is NOT an U16Field or
        cannot be found.
";
...
%feature("docstring") gmsec::api::Message::addConfig "
    ...
    used to pass middleware specific items to the Message object.
    ...
    Parameters
    ----------
    config: Config that contains configuration values to add to the
        Message.
";
