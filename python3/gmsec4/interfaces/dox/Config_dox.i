...
%feature("docstring") gmsec::api::Config "
    ...
    This constructor will parse command line parameters and add values
    for any param that is of the form <name>=<value>. This constructor
    will parse command line parameters and add values for any parameter
    ...
    libgmsec_python3.Config(data)

    This constructor will create a Config object by parsing key/value
    ...
    Exceptions
    ----------
    A GmsecError is thrown if the data string is None, or contains an
    empty string.
    A GmsecError is thrown if the data string is not parsable.

    libgmsec_python3.Config(cfg)
...
%feature("docstring") gmsec::api::Config::getBooleanValue "
    ...
    This function attempts to get the boolean representation of
    ...
    name: string
        name of value to get
    defaultValue: default value to be returned if no value exist for
    name parameter
...
%feature("docstring") gmsec::api::Config::getIntegerValue "
    ...
    This function attempts to get the integer representation of
    configuration element. An exception is thrown if the element does
    ...
    name: string
        name of value to get
    defaultValue: 
        default value to be returned if no value exists for name
        parameter
...
%feature("docstring") gmsec::api::Config::addValue "
    ...
    Exceptions
    ----------
    A GmsecError is thrown if either name or value are None, or are
    empty strings
...
%feature("docstring") gmsec::api::Config::merge "
    ...
    overwriteExisting: [optional] overwriteExisting - indicates whether
    to overwrite any existing name/value pairs within the working
    Config object.  If flag is omitted, then the default is to
    overwrite existing name/value pairs.
";
...
%feature("docstring") gmsec::api::Config::getValue "
    ...
    This function gets a value by name. The scope of the value is the
    ...
    This function gets a value by name and if there is no value
...
%feature("docstring") gmsec::api::Config::getDoubleValue "
    ...
    This function attempts to get the double representation of
    configuration element. An exception is thrown if the element does
    ...
    name: string
        name of value to get
    defaultValue: float
        default value to be returned if no value exist for name
        parameter
