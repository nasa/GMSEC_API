...
%feature("docstring") list<gmsec::api::mist::DeviceParam*> "
    ...
    param1 = libgmsec_python3.DeviceParam(\"param1\", \"timestamp\",
                                          paramval1)
    param2 = libgmsec_python3.DeviceParam(\"param2\", \"timestamp\",
                                          paramval2)
    param3 = libgmsec_python3.DeviceParam(\"param3\", \"timestamp\",
                                          paramval3)
