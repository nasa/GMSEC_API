...
%feature("docstring") gmsec::api::util::Log::registerHandler "
    ...
    This function registers a LogHandler that will be called for all
    logging levels.
    ...
    This function registers a LogHandler that will be called for a
...
%feature("docstring") gmsec::api::util::Log::toString "
    ...
    \"ERROR,\" \"SECURE,\" \"WARNING,\" \"INFO,\" \"VERBOSE,\"
    \"DEBUG,\" or \"INVALID\"
";
