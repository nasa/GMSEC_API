...
extern "C"
{
	...
	Java_gov_nasa_gsfc_gmsec_api5_jni_gmsecJNI_initialize(JNIEnv *jenv, jclass cls)
	{
	...
	JNIEXPORT void JNICALL
	Java_gov_nasa_gsfc_gmsec_api5_jni_gmsecJNI_setEnableDetach (JNIEnv *jenv, jclass jcls, jboolean enableDetach)
	{
