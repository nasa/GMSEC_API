...
void CxxEventCallbackProxy::onEvent(Connection& conn, const Status& status, Connection::Event event)
{
	if (!jCallback)
	{
...
JNIEXPORT void JNICALL Java_gov_nasa_gsfc_gmsec_api5_jni_gmsecJNI_delete_1EventCallback
