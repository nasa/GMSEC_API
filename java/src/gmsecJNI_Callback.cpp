...
JNIEXPORT jlong JNICALL Java_gov_nasa_gsfc_gmsec_api5_jni_gmsecJNI_new_1Callback
  (JNIEnv *jenv, jclass jcls, jobject callback)
{
	Callback* proxy = new CxxCallbackProxy(jenv, callback);

	return JNI_POINTER_TO_JLONG(proxy);
}


JNIEXPORT void JNICALL Java_gov_nasa_gsfc_gmsec_api5_jni_gmsecJNI_delete_1Callback
