...
public class Status
{
	 ...
	 * @see StatusCode
	 */
	public Status(int clazz, int code, String reason)
	{
	 ...
	 * @see StatusCode
	 */
	public Status(int clazz, int code, String reason, int customCode)
	{
		m_class      = clazz;
		m_code       = code;
		m_reason     = reason;
	...
	/**
	 * Constructs a Status object with info from the given GmsecException object.
	 *
	 * @param e GmsecException object indicating source/reason for the error
	 *
		...
		throws IllegalArgumentException
	{
		if (e == null)
		{
			throw new IllegalArgumentException("GmsecException object is null");
		}
	...
	public String get()
	{
		...
		sb.append("[").append(m_class).append(",").append(m_code).append(",")
