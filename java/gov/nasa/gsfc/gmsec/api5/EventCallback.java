...
import gov.nasa.gsfc.gmsec.api5.jni.JNIEventCallback;


/**
 * This class is the abstract base class for event callbacks.
 * A user created class, derived from this class, can be passed to
 * {@link Connection#registerEventCallback(Connection.Event, EventCallback)}
 ...
 *
 * @see Connection#registerEventCallback(Connection.Event, EventCallback)
 */
public abstract class EventCallback
{
	 ...
	 */
	public abstract void onEvent(Connection conn, Status status, Connection.Event event);
}
