...
%extend gmsec::api::StringField {
    ...
    static StringField* CALL_TYPE castField(Field* field)
    {
...
C<libgmsec_perl::StringField-E<gt>new($name, $value)>

        Constructor for creating specialized Field object containing string value.
...
C<libgmsec_perl::StringField-E<gt>new($field)>

        Copy-constructor for instantiating a copy of another StringField

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $field - the StringField to copy



=head3 DESTROY

C<libgmsec_perl::StringField-E<gt>DESTROY()>
...
C<libgmsec_perl::StringField-E<gt>getValue()>
...
C<libgmsec_perl::StringField-E<gt>clone()>
...
C<libgmsec_perl::StringField-E<gt>castField()>

        Converts the given Field object to a StringField object.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        Field object that represents a StringField.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An exception is thrown if the field object cannot be converted to a StringField.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Returns:</b><br>

        Returns the StringField representation of the given field object.
...
C<libgmsec_perl::Field-E<gt>toXML()>
        ...
        Note: Implementation is specific to StringField
