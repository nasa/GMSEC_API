...
%extend gmsec::api::F64Field {
    ...
    static F64Field* CALL_TYPE castField(Field* field)
    {
        ...
        if (casted == NULL)
        {
            throw Exception(FIELD_ERROR, FIELD_TYPE_MISMATCH, "Field cannot be casted to an F64Field");
        }
...
C<libgmsec_perl::F64Field-E<gt>new($name, $value)>
...
C<libgmsec_perl::F64Field-E<gt>clone()>
