...
%extend gmsec::api::I8Field {
    ...
    static I8Field* CALL_TYPE castField(Field* field)
    {
        I8Field* casted = dynamic_cast<I8Field*>(field);

        if (casted == NULL)
        {
            throw Exception(FIELD_ERROR, FIELD_TYPE_MISMATCH, "Field cannot be casted to an I8Field");
        }
...
C<libgmsec_perl::I8Field-E<gt>new($name, $value)>

        Constructor for creating specialized Field object containing signed 8-bit value.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $name - the name of the Field
        $value - the signed 8-bit value to store

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An Exception is thrown if the name is NULL, or is an empty string.

C<libgmsec_perl::I8Field-E<gt>new($field)>

        Copy-constructor for instantiating a copy of another I8Field

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $field - the I8Field to copy



=head3 DESTROY

C<libgmsec_perl::I8Field-E<gt>DESTROY()>
...
C<libgmsec_perl::I8Field-E<gt>getValue()>
...
C<libgmsec_perl::I8Field-E<gt>clone()>
...
C<libgmsec_perl::I8Field-E<gt>castField()>

        Converts the given Field object to an I8Field object.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        Field object that represents an I8Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An exception is thrown if the field object cannot be converted to an I8Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Returns:</b><br>

        Returns the I8Field representation of the given field object.
...
C<libgmsec_perl::Field-E<gt>toXML()>
        ...
        Note: Implementation is specific to I8Field
