...
%extend gmsec::api::U8Field {
    ...
    static U8Field* CALL_TYPE castField(Field* field)
    {
...
C<libgmsec_perl::U8Field-E<gt>new($name, $value)>

        Constructor for creating specialized Field object containing an unsigned 8-bit value.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $name - the name of the Field
        $value - the unsigned 8-bit value to store

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An Exception is thrown if the name is NULL, or is an empty string.

C<libgmsec_perl::U8Field-E<gt>new($field)>

        Copy-constructor for instantiating a copy of another U8Field

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $field - the U8Field to copy



=head3 DESTROY

C<libgmsec_perl::U8Field-E<gt>DESTROY()>
...
C<libgmsec_perl::U8Field-E<gt>getValue()>
...
C<libgmsec_perl::U8Field-E<gt>clone()>
...
C<libgmsec_perl::U8Field-E<gt>castField()>

        Converts the given Field object to a U8Field object.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        Field object that represents a U8Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An exception is thrown if the field object cannot be converted to a U8Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Returns:</b><br>

        Returns the U8Field representation of the given field object.
...
C<libgmsec_perl::Field-E<gt>toXML()>
        ...
        Note: Implementation is specific to U8Field
