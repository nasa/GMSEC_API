...
%extend gmsec::api::I64Field {
    ...
    static I64Field* CALL_TYPE castField(Field* field)
    {
        I64Field* casted = dynamic_cast<I64Field*>(field);

        if (casted == NULL)
        {
            throw Exception(FIELD_ERROR, FIELD_TYPE_MISMATCH, "Field cannot be casted to an I64Field");
        }
...
C<libgmsec_perl::I64Field-E<gt>new($name, $value)>

        Constructor for creating specialized Field object containing signed 64-bit value.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $name - the name of the Field
        $value - the signed 64-bit value to store

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An Exception is thrown if the name is NULL, or is an empty string.

C<libgmsec_perl::I64Field-E<gt>new($field)>

        Copy-constructor for instantiating a copy of another I64Field

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $field - the I64Field to copy



=head3 DESTROY

C<libgmsec_perl::I64Field-E<gt>DESTROY()>
...
C<libgmsec_perl::I64Field-E<gt>getValue()>
...
C<libgmsec_perl::I64Field-E<gt>clone()>
...
C<libgmsec_perl::I64Field-E<gt>castField()>

        Converts the given Field object to an I64Field object.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        Field object that represents an I64Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An exception is thrown if the field object cannot be converted to an I64Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Returns:</b><br>

        Returns the I64Field representation of the given field object.
...
C<libgmsec_perl::Field-E<gt>toXML()>
        ...
        Note: Implementation is specific to I64Field
