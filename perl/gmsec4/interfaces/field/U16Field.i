...
%extend gmsec::api::U16Field {
    U16Field* CALL_TYPE clone() const
    {
        return dynamic_cast<U16Field*>(self->clone());
    }

    static U16Field* CALL_TYPE castField(Field* field)
    {
        U16Field* casted = dynamic_cast<U16Field*>(field);

        if (casted == NULL)
        {
            throw Exception(FIELD_ERROR, FIELD_TYPE_MISMATCH, "Field cannot be casted to a U16Field");
        }
...
C<libgmsec_perl::U16Field-E<gt>clone()>
...
C<libgmsec_perl::U16Field-E<gt>castField()>

        Converts the given Field object to a U16Field object.
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Returns:</b><br>
        ...
        Returns the U16Field representation of the given field object.
