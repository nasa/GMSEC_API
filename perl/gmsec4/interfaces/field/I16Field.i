...
%extend gmsec::api::I16Field {
    ...
    static I16Field* CALL_TYPE castField(Field* field)
    {
        I16Field* casted = dynamic_cast<I16Field*>(field);

        if (casted == NULL)
        {
            throw Exception(FIELD_ERROR, FIELD_TYPE_MISMATCH, "Field cannot be casted to an I16Field");
        }
...
C<libgmsec_perl::I16Field-E<gt>new($name, $value)>

        Constructor for creating specialized Field object containing signed 16-bit value.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $name - the name of the Field
        $value - the signed 16-bit value to store

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An Exception is thrown if the name is NULL, or is an empty string.

C<libgmsec_perl::I16Field-E<gt>new($field)>

        Copy-constructor for instantiating a copy of another I16Field

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $field - the I16Field to copy



=head3 DESTROY

C<libgmsec_perl::I16Field-E<gt>DESTROY()>
...
C<libgmsec_perl::I16Field-E<gt>getValue()>
...
C<libgmsec_perl::I16Field-E<gt>clone()>
...
C<libgmsec_perl::I16Field-E<gt>castField()>

        Converts the given Field object to an I16Field object.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        Field object that represents an I16Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An exception is thrown if the field object cannot be converted to an I16Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Returns:</b><br>

        Returns the I16Field representation of the given field object.
...
C<libgmsec_perl::Field-E<gt>toXML()>
        ...
        Note: Implementation is specific to I16Field
