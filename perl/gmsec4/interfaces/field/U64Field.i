...
%extend gmsec::api::U64Field {
    ...
    static U64Field* CALL_TYPE castField(Field* field)
    {
...
C<libgmsec_perl::U64Field-E<gt>new($name, $value)>

        Constructor for creating specialized Field object containing an unsigned 64-bit value.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $name - the name of the Field
        $value - the unsigned 64-bit value to store

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An Exception is thrown if the name is NULL, or is an empty string.

C<libgmsec_perl::U64Field-E<gt>new($field)>

        Copy-constructor for instantiating a copy of another U64Field

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $field - the U64Field to copy



=head3 DESTROY

C<libgmsec_perl::U64Field-E<gt>DESTROY()>
...
C<libgmsec_perl::U64Field-E<gt>getValue()>
...
C<libgmsec_perl::U64Field-E<gt>clone()>
...
C<libgmsec_perl::U64Field-E<gt>castField()>

        Converts the given Field object to a U64Field object.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        Field object that represents a U64Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An exception is thrown if the field object cannot be converted to a U64Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Returns:</b><br>

        Returns the U64Field representation of the given field object.
...
C<libgmsec_perl::Field-E<gt>toXML()>
        ...
        Note: Implementation is specific to U64Field
