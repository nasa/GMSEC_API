...
%extend gmsec::api::I32Field {
    ...
    static I32Field* CALL_TYPE castField(Field* field)
    {
        ...
        if (casted == NULL)
        {
            throw Exception(FIELD_ERROR, FIELD_TYPE_MISMATCH, "Field cannot be casted to an I32Field");
        }
...
C<libgmsec_perl::I32Field-E<gt>new($name, $value)>
...
C<libgmsec_perl::I32Field-E<gt>clone()>
