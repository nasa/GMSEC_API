...
%extend gmsec::api::CharField {
    ...
    static CharField* CALL_TYPE castField(Field* field)
    {
...
C<libgmsec_perl::CharField-E<gt>new($name, $value)>

        Constructor for creating specialized Field object containing character value.
...
C<libgmsec_perl::CharField-E<gt>new($field)>

        Copy-constructor for instantiating a copy of another CharField

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $field - the CharField to copy



=head3 DESTROY

C<libgmsec_perl::CharField-E<gt>DESTROY()>
...
C<libgmsec_perl::CharField-E<gt>getValue()>
...
C<libgmsec_perl::CharField-E<gt>clone()>
...
C<libgmsec_perl::CharField-E<gt>castField()>

        Converts the given Field object to a CharField object.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        Field object that represents a CharField.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An exception is thrown if the field object cannot be converted to a CharField.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Returns:</b><br>

        Returns the CharField representation of the given field object.
...
C<libgmsec_perl::Field-E<gt>toXML()>
        ...
        Note: Implementation is specific to CharField
