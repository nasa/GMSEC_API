...
%extend gmsec::api5::I32Field {
    static I32Field* CALL_TYPE castField(Field* field)
    {
        I32Field* casted = dynamic_cast<I32Field*>(field);

        if (casted == NULL)
        {
            throw GmsecException(FIELD_ERROR, FIELD_TYPE_MISMATCH, "Field cannot be casted to an I32Field");
        }
...
C<libgmsec_perl::I32Field-E<gt>new($name, $value, $isHeader)>

        Constructor for creating specialized Field object containing signed 32-bit value.
...
C<libgmsec_perl::I32Field-E<gt>new($field)>

        Copy-constructor for instantiating a copy of another I32Field

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $field - the I32Field to copy



=head3 DESTROY

C<libgmsec_perl::I32Field-E<gt>DESTROY()>
...
C<libgmsec_perl::I32Field-E<gt>getValue()>
...
C<libgmsec_perl::I32Field-E<gt>castField()>

        Converts the given Field object to an I32Field object.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        Field object that represents an I32Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        An exception is thrown if the field object cannot be converted to an I32Field.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Returns:</b><br>

        Returns the I32Field representation of the given field object.
...
C<libgmsec_perl::Field-E<gt>toXML()>
        ...
        Note: Implementation is specific to I32Field
