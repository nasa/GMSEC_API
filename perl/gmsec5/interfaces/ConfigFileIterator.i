...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>
        ...
        $libgmsec_perl::GmsecException is thrown if no more config entries are available.
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>
        ...
        $libgmsec_perl::GmsecException is thrown if no more message entries are available.
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>
        ...
        $libgmsec_perl::GmsecException is thrown if no more subscription entries are available.
