...
C<libgmsec_perl::Config-E<gt>new()>
        ...
        The MessageFactory will be configured with the default message specification used by the API.

        Once the ConfigFile object has been created, use load() to load a configuration file, or if
        the plan is to add elements to the empty ConfigFile object, then use save() to save any changes.
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>
        ...
        libgmsec_perl::GmsecException if the MessageFactory cannot be instantiated.
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Configuration options referenced:</b><br>
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>
        ...
        libgmsec_perl::GmsecException if file parsing error occurs
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>
        ...
        libgmsec_perl::GmsecException if error occurs writing to the file
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>
        ...
        libgmsec_perl::GmsecException if error occurs while parsing XML string
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exception:</b><br>
        ...
        libgmsec_perl::GmsecException for cases where configuration for the given name does not exist
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exception:</b><br>
        ...
        libgmsec_perl::GmsecException for cases where message configuration for the given name does not exist
...
=head3 addSubscriptionEntry

C<libgmsec_perl::ConfigFile-E<gt>addSubscriptionEntry($entry)>

        Adds a SubscriptionEntry definition to the list of subscriptions.
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>
        ...
        libgmsec_perl::GmsecException if name is NULL or contains an empty string
...
=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>
        ...
        libgmsec_perl::GmsecException if XML string is NULL, contains an empty string, or if an XML parsing error occurs

=head3 removeSubscriptionEntry

C<libgmsec_perl::ConfigFile-E<gt>removeSubscriptionEntry($name)>

        Removes the SubscriptionEntry definition which is mapped to the provided name.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $name - name associated with the subscription entry definition
...
C<libgmsec_perl::SubscriptionEntry-E<gt>new($name, $pattern)>

        Constructor

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $name    - subscription entry name
        $pattern - subscription pattern to associate with entry

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Exceptions:</b><br>

        libgmsec_perl::GmsecException if either name or subscription pattern are NULL or if either contains an empty string
...
=head3 addExcludedPattern

C<libgmsec_perl::SubscriptionEntry-E<gt>addExcludedPattern($pattern)>

        Adds subscription pattern to entry that should be excluded.

=for html &nbsp;&nbsp;&nbsp;&nbsp;<b>Parameters:</b><br>

        $pattern - subscription pattern to exclude
