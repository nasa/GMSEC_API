...
#ifndef GMSEC_MB_RESOURCE_DATA_H
#define GMSEC_MB_RESOURCE_DATA_H
...
private:
	...
	gmsec::api5::util::Mutex m_bytes_rcvd_mutex;
	gmsec::api5::util::Mutex m_bytes_sent_mutex;
	gmsec::api5::util::Mutex m_msgs_rcvd_mutex;
	gmsec::api5::util::Mutex m_msgs_sent_mutex;
