...
#ifndef GMSEC_MB_FAST_MESSAGE_H
#define GMSEC_MB_FAST_MESSAGE_H
...
{
public:
	MBFastMessage(gmsec::api5::Message* msg, void* creatorObject);
	 ...
	 * Provides a reference to the store GMSEC Message.
	 */
	const gmsec::api5::Message* get() const;
