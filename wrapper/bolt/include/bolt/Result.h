...
public:
	...
	gmsec::api5::util::LogStream &put(gmsec::api5::util::LogStream &os) const;
...
inline gmsec::api5::util::LogStream &operator<<(gmsec::api5::util::LogStream &os, const bolt::Result &result)
{
	return result.put(os);
}
