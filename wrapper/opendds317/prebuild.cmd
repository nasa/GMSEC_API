...
set SUPPORT=..\..\..\GMSEC_SUPPORT\opendds-3.14
...
%TAO_IDL% %GMSEC_IDL_FILE% -o %OBJDIR% --idl-version 4
%OPENDDS_IDL% %GMSEC_IDL_FILE% -o %OBJDIR% --idl-version 4
%TAO_IDL% -I%SRCDIR% -I%SUPPORT% -I%SUPPORT%\ACE_wrappers\TAO %OPENDDS_IDL_FILE% -o %OBJDIR% --idl-version 4
