...
#ifndef GMSEC_GENERICJMS_H
#define GMSEC_GENERICJMS_H
...
const char* kindToJMSType(gmsec::api5::Message::Kind kind);


gmsec::api5::Message::Kind jmsTypeToKind(const char* type);
