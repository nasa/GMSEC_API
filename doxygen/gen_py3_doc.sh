...
PY_DOC3=../../GMSEC_SUPPORT/python-3.10.7/bin/pydoc3
...
if [ $? -ne 0 ]; then
	echo "Error producing ${PY3_HTM}; aborting!"
	exit 1
fi
...
sed -i 's/gmsec::api5::Field:://g' ${PY3_HTM}
sed -i 's/gmsec::api5::MessageFactory:://g' ${PY3_HTM}
sed -i 's/gmsec::api5::Message:://g' ${PY3_HTM}
sed -i 's/gmsec::api5::util:://g' ${PY3_HTM}
sed -i 's/gmsec::api5:://g' ${PY3_HTM}
...
sed -i 's/MessageFactory \*/MessageFactory/g' ${PY3_HTM}
