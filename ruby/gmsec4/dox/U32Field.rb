...
module Libgmsec_ruby #:nodoc: don't document this
	...
	# This is a specialized Field class that can be used to store a 32-bit unsigned integer value.
	#
	# ==== Example Usage
	#
	...
	#
	#    begin
	#        field = Libgmsec_ruby::U32Field.new("MY-U32-FIELD", 3)
	#    end
	#
	class U32Field < Libgmsec_ruby::Field
		# Constructor.
		#
		# ==== Attributes
		#
