...
module Libgmsec_ruby #:nodoc: don't document this
	...
	# This is a specialized Field class that can be used to store a 16-bit unsigned integer value.
	#
	# ==== Example Usage
	#
	...
	#
	#    begin
	#        field = Libgmsec_ruby::U16Field.new("MY-U16-FIELD", 3)
	#    end
	#
	class U16Field < Libgmsec_ruby::Field
		# Constructor.
		#
		# ==== Attributes
		#
