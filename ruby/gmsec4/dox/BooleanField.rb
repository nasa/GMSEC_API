...
module Libgmsec_ruby #:nodoc: don't document this
	...
	# This is a specialized Field class that can be used to store a boolean value.
	#
	# ==== Example Usage
	#
	...
	#
	#    begin
	#        field = Libgmsec_ruby::BooleanField.new("MY-BOOLEAN-FIELD", true)
	#    end
	#
	class BooleanField < Libgmsec_ruby::Field
		# Constructor.
		#
		# ==== Attributes
		#
	    # * +name+  - The name of the binary field.
	    # * +value+ - The boolean value of the field.
		#
		# ==== Raises
		#
