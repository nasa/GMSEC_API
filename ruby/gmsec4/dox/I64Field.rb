...
module Libgmsec_ruby #:nodoc: don't document this
	...
	# This is a specialized Field class that can be used to store a 64-bit integer value.
	#
	# ==== Example Usage
	#
	...
	#
	#    begin
	#        field = Libgmsec_ruby::I64Field.new("MY-I64-FIELD", 3)
	#    end
	#
	class I64Field < Libgmsec_ruby::Field
		# Constructor.
		#
		# ==== Attributes
		#
