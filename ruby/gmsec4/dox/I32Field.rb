...
module Libgmsec_ruby #:nodoc: don't document this
	...
	# This is a specialized Field class that can be used to store a 32-bit integer value.
	#
	# ==== Example Usage
	#
	...
	#
	#    begin
	#        field = Libgmsec_ruby::I32Field.new("MY-I32-FIELD", 3)
	#    end
	#
	class I32Field < Libgmsec_ruby::Field
		# Constructor.
		#
		# ==== Attributes
		#
