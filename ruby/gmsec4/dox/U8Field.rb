...
module Libgmsec_ruby #:nodoc: don't document this
	...
	# This is a specialized Field class that can be used to store an 8-bit unsigned integer value.
	#
	# ==== Example Usage
	#
	...
	#
	#    begin
	#        field = Libgmsec_ruby::U8Field.new("MY-U8-FIELD", 3)
	#    end
	#
	class U8Field < Libgmsec_ruby::Field
		# Constructor.
		#
		# ==== Attributes
		#
