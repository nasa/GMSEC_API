...
module Libgmsec_ruby #:nodoc: don't document this
	...
	# This is a specialized Field class that can be used to store a 16-bit integer value.
	#
	# ==== Example Usage
	#
	...
	#
	#    begin
	#        field = Libgmsec_ruby::I16Field.new("MY-I16-FIELD", 3)
	#    end
	#
	class I16Field < Libgmsec_ruby::Field
		# Constructor.
		#
		# ==== Attributes
		#
