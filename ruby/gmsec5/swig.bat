...
echo "%SWIG_HOME%\swig.exe" -DSWIG_BINDING -DCHAR_BIT=8 -c++ -ruby -I..\..\framework\include -I"!_VCInstallDir!include" -I"!INCLUDE!" "!_InputFile!"
"%SWIG_HOME%\swig.exe" -DSWIG_BINDING -DCHAR_BIT=8 -c++ -ruby -I..\..\framework\include -I"!_VCInstallDir!include" -I"!INCLUDE!" "!_InputFile!"
