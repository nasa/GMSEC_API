...
module Libgmsec_ruby #:nodoc: don't document this
	...
	class TimeUtil
		...
		# ==== Attributes
		#
		# * +time_str+ - The time string in the format of YYYY-DDD-HH:MM:SS[.sss]
		#
		# ==== Returns
		#
		# A GMSEC_TimeSpec object is returned.
        ...
        # ==== Raises
        #
        # A GmsecException is thrown if an invalid time string is given.
		#
		def self.convert_time_string(time_str)
		end
        ...
        # A GmsecException is thrown if an invalid time string is given.
		#
		def self.convert_time_string_s(time_str)
		end
