...
module Libgmsec_ruby #:nodoc: don't document this
	...
	#
	#        begin
	#            conn = Libgmsec_ruby::Connection.new( config )
	...
	class Config
		...
		#
		# * Constructor that populates the Config object using XML, JSON, or string data that define key=value pairs.
		#
		#     Libgmsec_ruby::Config.new(data, type)
		#
		# * Copy constructor.
		#
        ...
        # ==== Raises
        #
        # A GmsecException is thrown if the file name is null, or consists of an empty string.
        # A GmsecException is thrown if the file cannot be opened.
        # A GmsecException is thrown if the file does not contain a valid configuration construct.
        # A GmsecException is thrown if the file does not contain the named configuration construct.
		#
		# ==== See also
		#
		# Config.from_xml
