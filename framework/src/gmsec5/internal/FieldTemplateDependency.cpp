...
const std::string& FieldTemplateDependency::getNewPattern() const
{
	return m_newPattern;
}
...
void FieldTemplateDependency::setNewPattern(const std::string & newPattern)
{
	m_newPattern = newPattern;
}

void FieldTemplateDependency::setNewValues(const std::list<std::string>& newValues)
{
	m_newValues = newValues;
}

void FieldTemplateDependency::setNewTypes(const std::list<std::string>& newTypes)
{
	m_newTypes = newTypes;
}

void FieldTemplateDependency::setConditions(const std::string& valueEquals, const std::string& valueGreaterThan, const std::string& valueLessThan)
{
