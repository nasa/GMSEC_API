...
extern "C"
{
	 ...
	 *	   DestroyField
	 */
	GMSEC_API void CALL_TYPE CreateField(GMSEC_FIELD_HANDLE *fld, GMSEC_STATUS_HANDLE status);
	 ...
	 *	   MsgGetField
	 */
	GMSEC_API void CALL_TYPE DestroyField(GMSEC_FIELD_HANDLE *fld, GMSEC_STATUS_HANDLE status);
	 ...
	 *
	 */
	GMSEC_API void CALL_TYPE GetFieldName(GMSEC_FIELD_HANDLE fld, char **name, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldName(GMSEC_FIELD_HANDLE fld, char *name, GMSEC_STATUS_HANDLE status);
	 ...
	 * @sa GMSEC_TYPE
	 */
	GMSEC_API void CALL_TYPE SetFieldType(GMSEC_FIELD_HANDLE fld, GMSEC_TYPE ftype, GMSEC_STATUS_HANDLE status);
	 ...
	 * @sa GMSEC_TYPE
	 */
	GMSEC_API void CALL_TYPE GetFieldType(GMSEC_FIELD_HANDLE fld, GMSEC_TYPE *ftype, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueCHAR(GMSEC_FIELD_HANDLE fld, GMSEC_CHAR *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueBOOL(GMSEC_FIELD_HANDLE fld, GMSEC_BOOL *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueSHORT(GMSEC_FIELD_HANDLE fld, GMSEC_SHORT *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueUSHORT(GMSEC_FIELD_HANDLE fld, GMSEC_USHORT *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueLONG(GMSEC_FIELD_HANDLE fld, GMSEC_LONG *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueULONG(GMSEC_FIELD_HANDLE fld, GMSEC_ULONG *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueFLOAT(GMSEC_FIELD_HANDLE fld, GMSEC_FLOAT *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueDOUBLE(GMSEC_FIELD_HANDLE fld, GMSEC_DOUBLE *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueSTRING(GMSEC_FIELD_HANDLE fld, GMSEC_STRING *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueSTR(GMSEC_FIELD_HANDLE fld, GMSEC_STR *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueBIN(GMSEC_FIELD_HANDLE fld, GMSEC_BIN *value, GMSEC_U32 *size, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueI16(GMSEC_FIELD_HANDLE fld, GMSEC_I16 *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueU16(GMSEC_FIELD_HANDLE fld, GMSEC_U16 *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueI32(GMSEC_FIELD_HANDLE fld, GMSEC_I32 *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueU32(GMSEC_FIELD_HANDLE fld, GMSEC_U32 *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueF32(GMSEC_FIELD_HANDLE fld, GMSEC_F32 *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueF64(GMSEC_FIELD_HANDLE fld, GMSEC_F64 *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE GetFieldValueI64(GMSEC_FIELD_HANDLE fld, GMSEC_I64 *value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueCHAR(GMSEC_FIELD_HANDLE fld, GMSEC_CHAR value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueBOOL(GMSEC_FIELD_HANDLE fld, GMSEC_BOOL value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueSHORT(GMSEC_FIELD_HANDLE fld, GMSEC_SHORT value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueUSHORT(GMSEC_FIELD_HANDLE fld, GMSEC_USHORT value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueLONG(GMSEC_FIELD_HANDLE fld, GMSEC_LONG value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueULONG(GMSEC_FIELD_HANDLE fld, GMSEC_ULONG value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueFLOAT(GMSEC_FIELD_HANDLE fld, GMSEC_FLOAT value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueDOUBLE(GMSEC_FIELD_HANDLE fld, GMSEC_DOUBLE value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueSTRING(GMSEC_FIELD_HANDLE fld, GMSEC_STR value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueSTR(GMSEC_FIELD_HANDLE fld, GMSEC_STR value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueBIN(GMSEC_FIELD_HANDLE fld, GMSEC_BIN value, GMSEC_U32 size, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueI16(GMSEC_FIELD_HANDLE fld, GMSEC_I16 value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueU16(GMSEC_FIELD_HANDLE fld, GMSEC_U16 value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueI32(GMSEC_FIELD_HANDLE fld, GMSEC_I32 value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueU32(GMSEC_FIELD_HANDLE fld, GMSEC_U32 value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueF32(GMSEC_FIELD_HANDLE fld, GMSEC_F32 value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueF64(GMSEC_FIELD_HANDLE fld, GMSEC_F64 value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE SetFieldValueI64(GMSEC_FIELD_HANDLE fld, GMSEC_I64 value, GMSEC_STATUS_HANDLE status);
	 ...
	 * @param[out] status - operation result status
	 */
	GMSEC_API void CALL_TYPE UnSetField(GMSEC_FIELD_HANDLE fld, GMSEC_STATUS_HANDLE status);
