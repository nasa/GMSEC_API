...
#ifndef GMSEC_API5_I32FIELD_H
#define GMSEC_API5_I32FIELD_H
...
public:
	/**
	 * @fn I32Field(const char* name, GMSEC_I32 value, bool isHeader = false)
	 * @brief Constructor for creating a specialized Field object containing a signed 32-bit value.
	 ...
	 */
	I32Field(const char* name, GMSEC_I32 value, bool isHeader = false);


	/**
	 * @fn I32Field(const I32Field& other)
	 * @brief Copy-constructor for instantiating of copy of another I32Field
...
private:
	...
	gmsec::api5::internal::InternalI32Field* m_internal;
};
