...
#ifndef GMSEC_API5_UTIL_INTERNAL_CONDITION_H
#define GMSEC_API5_UTIL_INTERNAL_CONDITION_H
...
public:
	...
	InternalCondition(gmsec::api5::util::Mutex& mutex);


	~InternalCondition();


	gmsec::api5::util::Mutex& getMutex();
