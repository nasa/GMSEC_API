...
#ifndef GMSEC_API5_SCHEMA_ID_MAPPING_H
#define GMSEC_API5_SCHEMA_ID_MAPPING_H
...
struct SchemaIdMapping
{
	...
	std::string getSchemaId(const std::string& id, unsigned int msgSpecVersion) const
	{
		...
		{
			schemaId = (msgSpecVersion >= GMSEC_MSG_SPEC_2019_00 ? it->second.schemaId : it->second.legacySchemaId);
		}
