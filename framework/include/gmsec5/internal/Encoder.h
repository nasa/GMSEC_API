...
#ifndef GMSEC_API5_UTIL_ENCODER_H
#define GMSEC_API5_UTIL_ENCODER_H
...
public:
	...
	/**
	 * @fn encode(const Message& message, GMSEC_U64& bytes, gmsec::api5::util::DataBuffer& out)
	 *
	 * @brief This function encodes a message.
	 *
	 * @param message - The message to be encoded
	 ...
	 **/
	void encode(const Message& message, gmsec::api5::util::DataBuffer& out);
...
private:
	...
	gmsec::api5::util::DataBuffer  buffer;
	char*                          current;
	Encoder*                       encoder;
