...
#ifndef GMSEC_API5_INTERNAL_CALLBACK_LOOKUP_H
#define GMSEC_API5_INTERNAL_CALLBACK_LOOKUP_H
...
private:
	...
	gmsec::api5::util::StdUniquePtr<CallbackRegister> m_callbackRegister;
};
