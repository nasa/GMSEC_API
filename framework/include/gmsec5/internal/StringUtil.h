...
#ifndef GMSEC_API5_INTERNAL_STRING_UTIL_H
#define GMSEC_API5_INTERNAL_STRING_UTIL_H
...
public:
	...
	{
		DateTime()
			: m_valid(true), m_relative(false), m_future(true),
			  m_year(0), m_doy(0), m_hour(0), m_min(0), m_sec(0), m_milli(0),
			  m_milli_div(1)
		{
		}
	...
	/**
	* @fn split(const std::string& str, const std::string& delimiters)
	* @brief Splits a string and returns a vector of resulting strings.
	*/
	static std::vector<std::string> CALL_TYPE split(const std::string& str, const std::string& delimiters);
	 ...
	 */
	static gmsec::api5::util::Mutex& CALL_TYPE getSharedMutex();
	...
	/**
	 * @fn gmsec_compress(const gmsec::api5::util::DataBuffer& in, gmsec::api5::util::DataBuffer& out)
	 * @brief Compress the data in the given input buffer and place the result in the output buffer.
	 */
	static Status gmsec_compress(const gmsec::api5::util::DataBuffer& in, gmsec::api5::util::DataBuffer& out);


	/**
	 * @fn gmsec_uncompress(const gmsec::api5::util::DataBuffer& in, gmsec::api5::util::DataBuffer& out)
	 * @brief Uncompress the data in the given input buffer and place the result in the output buffer.
	 */
	static Status gmsec_uncompress(const gmsec::api5::util::DataBuffer& in, gmsec::api5::util::DataBuffer& out);


	/**
	 * @fn getBoolean(const char* value)
	 * @brief Validates and converts (if possible) the given value to a bool value.
	 * @throws A GmsecException is thrown if the value is NULL, or if it does not represent a bool
	 * value.
	 */
	 ...
	 * @throws A GmsecException is thrown if the data value cannot be converted.
	 */
	template<typename T>
	 ...
	 * @throws A GmsecException is thrown if the data value is NULL.
	 */
	...
	/**
	 * @fn DateTime isValidTimestamp(const std::string& fieldValue)
	 * @brief Reports whether the given time string is valid.
	 * @param value - the string to check
	 */
	static DateTime isValidTimestamp(const std::string& value);
	...
	/**
	 * @fn GMSEC_I32 I32_fromBinary(const Data& data)
	 * @brief Converts the given data blob into a GMSEC_I32 value.
	 * @param data - Binary data blob
	 */
	static GMSEC_I32 I32_fromBinary(const Data& data);
	...
	/**
	 * @fn GMSEC_U32 U32_fromBinary(const Data& data)
	 * @brief Converts the given data blob into a GMSEC_U32 value.
	 * @param data - Binary data blob
	 */
	static GMSEC_U32 U32_fromBinary(const Data& data);
	...
	/**
	 * @fn const char* xmlErrorToString(tinyxml2::XMLError error)
	 * @brief Returns text string to describe the given XMLError.
	 */
