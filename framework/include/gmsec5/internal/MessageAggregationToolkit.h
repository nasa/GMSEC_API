...
#ifndef GMSEC_API5_INTERNAL_MESSAGE_AGGREGATION_TOOLKIT_H
#define GMSEC_API5_INTERNAL_MESSAGE_AGGREGATION_TOOLKIT_H
...
public:
	 ...
	 */
	static bool isAggregatedMsg(const Message* msg);
	 ...
	 */
	static void runThread(gmsec::api5::util::StdSharedPtr<MessageAggregationToolkit> shared);
...
private:
	...
	gmsec::api5::internal::ExclusionFilter m_messageFilter;

	Status                                 m_publishStatus;

	gmsec::api5::util::Condition           m_condition;
	gmsec::api5::internal::MessageEncoder  m_encoder;
	gmsec::api5::internal::MessageDecoder  m_decoder;
};
