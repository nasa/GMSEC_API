...
#ifndef GMSEC_API5_ERRORS_H
#define GMSEC_API5_ERRORS_H
...
enum StatusClass
{
	...
	RESOURCE_GENERATOR_ERROR = 13,      ///< ResourceGenerator error
	HEARTBEAT_GENERATOR_ERROR = 14,     ///< HeartbeatGenerator error
	SPECIFICATION_ERROR = 15,           ///< Specification error
	MSG_FACTORY_ERROR = 16,             ///< Message Factory error
	MSG_TEMPLATE_ERROR = 17,            ///< Message Template error
	FIELD_TEMPLATE_ERROR = 18,          ///< Message Template error
...
enum StatusCode
{
	...
	INCORRECT_FIELD_TYPE = 108,				///< Incorrect field type
