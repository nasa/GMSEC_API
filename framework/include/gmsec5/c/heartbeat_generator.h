...
#ifndef GMSEC_API5_C_HEARTBEAT_GENERATOR_H
#define GMSEC_API5_C_HEARTBEAT_GENERATOR_H
...
extern "C"
{
	...
	/**
	 * @fn GMSEC_HeartbeatGenerator heartbeatGeneratorCreate(GMSEC_Config config,
	 *                                                       GMSEC_U16    hbPubRate,
	 *                                                       GMSEC_Status status)
	 *
	 ...
	 */
	GMSEC_API GMSEC_HeartbeatGenerator heartbeatGeneratorCreate(GMSEC_Config config,
	                                                            GMSEC_U16    hbPubRate,
	                                                            GMSEC_Status status);


	/**
	 * @fn GMSEC_HeartbeatGenerator heartbeatGeneratorCreateWithFields(GMSEC_Config config,
	 *                                                                 GMSEC_U16    hbPubRate,
	 *                                                                 GMSEC_Field  fields[],
	 *                                                                 size_t       numFields,
	 *                                                                 GMSEC_Status status)
	 ...
	 * @sa heartbeatGeneratorDestroy
	 */
	GMSEC_API GMSEC_HeartbeatGenerator heartbeatGeneratorCreateWithFields(GMSEC_Config config,
	                                                                      GMSEC_U16    hbPubRate,
	                                                                      GMSEC_Field  fields[],
	                                                                      size_t       numFields,
	                                                                      GMSEC_Status status);
