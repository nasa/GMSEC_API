...
#ifndef GMSEC_API5_C_SCHEMA_ID_ITERATOR_H
#define GMSEC_API5_C_SCHEMA_ID_ITERATOR_H
...
extern "C"
{
	...
	/**
	 * @fn GMSEC_BOOL schemaIDIteratorHasNext(GMSEC_SchemaIDIterator iter, GMSEC_Status status)
	 *
	 ...
	 */
	GMSEC_API GMSEC_BOOL schemaIDIteratorHasNext(GMSEC_SchemaIDIterator iter, GMSEC_Status status);
