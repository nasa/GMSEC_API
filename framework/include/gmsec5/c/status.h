...
#ifndef GMSEC_API5_C_STATUS_H
#define GMSEC_API5_C_STATUS_H

#include <gmsec5/c/errors.h>
...
extern "C"
{
	 ...
	 * @sa destroyStatus()
	 */
	GMSEC_API GMSEC_Status statusCreateWithValues(GMSEC_I32 clazz, GMSEC_I32 code, const char* reason, GMSEC_I32 custom);


	/**
	 * @fn GMSEC_Status statusCreateCopy(GMSEC_Status other)
	 *
	 ...
	 * @sa destroyStatus()
	 */
	GMSEC_API GMSEC_Status statusCreateCopy(GMSEC_Status other);
	...
	/**
	 * @fn GMSEC_BOOL statusHasError(GMSEC_Status status)
	 *
	 ...
	 */
	GMSEC_API GMSEC_BOOL statusHasError(GMSEC_Status status);


	/**
	 * @fn const char* statusGet(GMSEC_Status status)
	 *
	 ...
	 * @return error string
	 */
	GMSEC_API const char* statusGet(GMSEC_Status status);


	/**
	 * @fn void statusSet(GMSEC_Status status, GMSEC_I32 clazz, GMSEC_I32 code, const char* reason, GMSEC_I32 custom)
	 *
	 ...
	 * @sa destroyStatus()
	 */
	GMSEC_API void statusSet(GMSEC_Status status, GMSEC_I32 clazz, GMSEC_I32 code, const char* reason, GMSEC_I32 custom);


	/**
	 * @fn GMSEC_I32 statusGetClass(GMSEC_Status status)
	 *
	 ...
	 * @sa errors.h
	 */
	GMSEC_API GMSEC_I32 statusGetClass(GMSEC_Status status);


	/**
	 * @fn void statusSetClass(GMSEC_Status status, GMSEC_I32 clazz)
	 *
	 ...
	 * @sa errors.h
	 */
	GMSEC_API void statusSetClass(GMSEC_Status status, GMSEC_I32 clazz);


	/**
	 * @fn GMSEC_I32 statusGetCode(GMSEC_Status status)
	 *
	 ...
	 * @sa errors.h
	 */
	GMSEC_API GMSEC_I32 statusGetCode(GMSEC_Status status);


	/**
	 * @fn void statusSetCode(GMSEC_Status status, GMSEC_I32 code)
	 *
	 ...
	 * @sa errors.h
	 */
	GMSEC_API void statusSetCode(GMSEC_Status status, GMSEC_I32 code);


	/**
	 * @fn const char* statusGetReason(GMSEC_Status status)
	 *
	 ...
	 * @return error string
	 */
	GMSEC_API const char* statusGetReason(GMSEC_Status status);
	...
	/**
	 * @fn GMSEC_I32 statusGetCustomCode(GMSEC_Status status)
	 *
	 ...
	 */
	GMSEC_API GMSEC_I32 statusGetCustomCode(GMSEC_Status status);
