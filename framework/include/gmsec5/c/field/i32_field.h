 ...
 * GMSEC_Field  field  = i32FieldCreate("I32-FIELD", 1234, GMSEC_FALSE, status);
 *
 * if (!field)
 * {
...
#ifndef GMSEC_API5_C_I32_FIELD_H
#define GMSEC_API5_C_I32_FIELD_H
...
extern "C"
{
	...
	/**
	 * @fn GMSEC_Field i32FieldCreate(const char* fieldName, GMSEC_I32 value, GMSEC_BOOL isHeader, GMSEC_Status status)
	 *
	 ...
	 * @sa fieldDestroy()
	 */
	GMSEC_API GMSEC_Field i32FieldCreate(const char* fieldName, GMSEC_I32 value, GMSEC_BOOL isHeader, GMSEC_Status status);


	/**
	 * @fn GMSEC_I32 i32FieldGetValue(GMSEC_Field field, GMSEC_Status status)
	 *
	 * @note A status object MUST BE CREATED with statusCreate() and
	 * passed in as the status parameter in order to receive any resulting status.
	 *
	 ...
	 */
	GMSEC_API GMSEC_I32 i32FieldGetValue(GMSEC_Field field, GMSEC_Status status);
