...
#ifndef GMSEC_API5_C_BOOLEAN_FIELD_H
#define GMSEC_API5_C_BOOLEAN_FIELD_H
...
extern "C"
{
	...
	/**
	 * @fn GMSEC_Field booleanFieldCreate(const char* fieldName, GMSEC_BOOL value, GMSEC_BOOL isHeader, GMSEC_Status status)
	 *
	 ...
	 * @sa fieldDestroy()
	 */
	GMSEC_API GMSEC_Field booleanFieldCreate(const char* fieldName, GMSEC_BOOL value, GMSEC_BOOL isHeader, GMSEC_Status status);


	/**
	 * @fn GMSEC_BOOL booleanFieldGetValue(GMSEC_Field field, GMSEC_Status status)
	 *
	 * @note A status object MUST BE CREATED with statusCreate() and
	 * passed in as the status parameter in order to receive any resulting status.
	 *
	 ...
	 */
	GMSEC_API GMSEC_BOOL booleanFieldGetValue(GMSEC_Field field, GMSEC_Status status);
