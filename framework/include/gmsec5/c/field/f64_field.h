 ...
 * GMSEC_Field  field  = f64FieldCreate("F64-FIELD", 1234.0, GMSEC_FALSE, status);
 *
 * if (!field)
 * {
...
#ifndef GMSEC_API5_C_F64_FIELD_H
#define GMSEC_API5_C_F64_FIELD_H
...
extern "C"
{
	...
	/**
	 * @fn GMSEC_Field f64FieldCreate(const char* fieldName, GMSEC_F64 value, GMSEC_BOOL isHeader, GMSEC_Status status)
	 *
	 ...
	 * @sa fieldDestroy()
	 */
	GMSEC_API GMSEC_Field f64FieldCreate(const char* fieldName, GMSEC_F64 value, GMSEC_BOOL isHeader, GMSEC_Status status);


	/**
	 * @fn GMSEC_F64 f64FieldGetValue(GMSEC_Field field, GMSEC_Status status)
	 *
	 * @note A status object MUST BE CREATED with statusCreate() and
	 * passed in as the status parameter in order to receive any resulting status.
	 *
	 ...
	 */
	GMSEC_API GMSEC_F64 f64FieldGetValue(GMSEC_Field field, GMSEC_Status status);
