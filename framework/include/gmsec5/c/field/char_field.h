 ...
 * GMSEC_Field  field  = charFieldCreate("CHAR-FIELD", 'c', GMSEC_FALSE, status);
 *
 * if (!field)
 * {
...
#ifndef GMSEC_API5_C_CHAR_FIELD_H
#define GMSEC_API5_C_CHAR_FIELD_H
...
extern "C"
{
	...
	/**
	 * @fn GMSEC_Field charFieldCreate(const char* fieldName, GMSEC_CHAR value, GMSEC_BOOL isHeader, GMSEC_Status status)
	 *
	 ...
	 * @sa fieldDestroy()
	 */
	GMSEC_API GMSEC_Field charFieldCreate(const char* fieldName, GMSEC_CHAR value, GMSEC_BOOL isHeader, GMSEC_Status status);


	/**
	 * @fn GMSEC_CHAR charFieldGetValue(GMSEC_Field field, GMSEC_Status status)
	 *
	 * @note A status object MUST BE CREATED with statusCreate() and
	 * passed in as the status parameter in order to receive any resulting status.
	 *
	 ...
	 */
	GMSEC_API GMSEC_CHAR charFieldGetValue(GMSEC_Field field, GMSEC_Status status);
