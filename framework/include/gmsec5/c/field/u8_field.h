 ...
 * GMSEC_Field  field  = u8FieldCreate("U8-FIELD", 127, GMSEC_FALSE, status);
 *
 * if (!field)
 * {
...
#ifndef GMSEC_API5_C_U8_FIELD_H
#define GMSEC_API5_C_U8_FIELD_H
...
extern "C"
{
	...
	/**
	 * @fn GMSEC_Field u8FieldCreate(const char* fieldName, GMSEC_U8 value, GMSEC_BOOL isHeader, GMSEC_Status status)
	 *
	 ...
	 * @sa fieldDestroy()
	 */
	GMSEC_API GMSEC_Field u8FieldCreate(const char* fieldName, GMSEC_U8 value, GMSEC_BOOL isHeader, GMSEC_Status status);


	/**
	 * @fn GMSEC_U8 u8FieldGetValue(GMSEC_Field field, GMSEC_Status status)
	 *
	 * @note A status object MUST BE CREATED with statusCreate() and
	 * passed in as the status parameter in order to receive any resulting status.
	 *
	 ...
	 */
	GMSEC_API GMSEC_U8 u8FieldGetValue(GMSEC_Field field, GMSEC_Status status);
