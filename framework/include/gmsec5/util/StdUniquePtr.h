...
#ifndef GMSEC_API5_UTIL_STD_UNIQUE_PTR_H
#define GMSEC_API5_UTIL_STD_UNIQUE_PTR_H
 ...
 * @class StdUniquePtr
 *
 * @brief A smart pointer that retains ownership of an
 * object of type-T through a pointer. The retained object
 * is deallocated when the last reference to the smart pointer
 * is destroyed, or the object is reset with another.
 */
template <typename T>
class StdUniquePtr
{
