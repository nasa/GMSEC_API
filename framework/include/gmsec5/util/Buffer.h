...
#ifndef GMSEC_API5_UTIL_BUFFER_H
#define GMSEC_API5_UTIL_BUFFER_H
 ...
 * @class Buffer
 *
 * @brief A templated class that can be used to store sequential data of type-T
 * within an array that is allocated on the heap.
 */
template<class T>
class Buffer
{
