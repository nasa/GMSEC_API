...
#ifndef GMSEC_API_INTERNAL_F64FIELD_H
#define GMSEC_API_INTERNAL_F64FIELD_H
...
class GMSEC_API InternalF64Field : public InternalField
{
public:
	InternalF64Field(const char* name, GMSEC_F64 value);
