...
#ifndef GMSEC_MIST_ABSTRACT_FIELD_DESCRIPTOR_H
#define GMSEC_MIST_ABSTRACT_FIELD_DESCRIPTOR_H
...
public:
	 ...
	 */
	virtual void setFieldVariables(const char* name, FieldMode mode, FieldClass clss, const char* description) = 0;
