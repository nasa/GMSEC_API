...
#ifndef GMSEC_MIST_COMPOUND_FIELD_DESCRIPTOR_H
#define GMSEC_MIST_COMPOUND_FIELD_DESCRIPTOR_H
...
public:
	...
	/** @fn CompoundFieldDescriptor(std::vector<AbstractFieldDescriptor*>& newChildren)
	 ...
	 *
	 * @param newChildren - vector of AbstractFieldDescriptor used to generate
	 * DescriptorList.  Ownership is taken by BaseCompoundFieldDescriptor
	 *
	 */
	CompoundFieldDescriptor(std::vector<AbstractFieldDescriptor*>& newChildren);
	 ...
	 *
	 * @param name - The BaseCompoundFieldDescriptor's name member is set to the name parameter
	 * @param mode - The BaseCompoundFieldDescriptor's mode member is set to the mode parameter
	 * @param clss - The BaseCompoundFieldDescriptor's class member is set to the clss parameter
	 * @param description - The BaseCompoundFieldDescriptor's description member is set to the description parameter
	 *
...
private:
	...
	internal::InternalCompoundFieldDescriptor* ptr;
