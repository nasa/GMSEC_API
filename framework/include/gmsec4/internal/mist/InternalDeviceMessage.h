...
#ifndef GMSEC_API_INTERNAL_DEVICE_MESSAGE_H
#define GMSEC_API_INTERNAL_DEVICE_MESSAGE_H
 ...
 *     MsgFieldIterator
 */
class GMSEC_API InternalDeviceMessage : public gmsec::api::internal::InternalMessage
{
  public:
	 ...
	 *
	 */
	InternalDeviceMessage(const char* subject, unsigned int version);
	 ...
	 *
	 */
	InternalDeviceMessage(const char* subject, const Config& config, unsigned int version);
...
private:
	...
	DeviceIterator                m_deviceIterator;
