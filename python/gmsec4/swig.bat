...
echo "%SWIG_HOME%\swig.exe" -DGMSEC_S16IL32LL64=1 -DCHAR_BIT=8 -c++ -python -classic -threads -I..\..\framework\include -I"!_VCInstallDir!include" -I"!INCLUDE!" "!_InputFile!"
"%SWIG_HOME%\swig.exe" -DGMSEC_S16IL32LL64=1 -DCHAR_BIT=8 -c++ -python -classic -threads -I..\..\framework\include -I"!_VCInstallDir!include" -I"!INCLUDE!" "!_InputFile!"
goto:patch


:buildLegacy
REM For Visual Studio 2008, 2010 or 2013
echo "%SWIG_HOME%\swig.exe" -DGMSEC_S16IL32LL64=1 -DCHAR_BIT=8 -c++ -python -classic -threads -I..\..\framework\include -I"!_VCInstallDir!include" "!_InputFile!"
"%SWIG_HOME%\swig.exe" -DGMSEC_S16IL32LL64=1 -DCHAR_BIT=8 -c++ -python -classic -threads -I..\..\framework\include -I"!_VCInstallDir!include" "!_InputFile!"
