...
%feature("docstring") gmsec::api::mist::ConnectionManager "
    ...
    Initializes the ConnectionManager instance without attempting a connection to the middleware.

    Note:
        Message validation will be disabled, unless otherwise indicated. If enabled, or if the configuration option GMSEC-MSG-CONTENT-VALIDATE is set to true, then messages will be validated against the default version of the GMSEC Interface Specification Document (ISD). The version of the ISD can be changed by specifying the configuration option GMSEC-SPECIFICATION-VERSION to a valid value (e.g. 201400).

    Parameters
    ----------
    cfg: The config object used to construct the underlying GMSEC connection object
...
%feature("docstring") gmsec::api::mist::ConnectionManager::requestDirective "
    ...
    fields: a list of and supplemental fields that the user wishes to include with the directive message.

    Exceptions
    ----------
    An Exception is thrown if the ConnectionManager has not been initialized.
    An Exception is thrown if the message cannot be validated, or if other severe error
        occurs while attempting to publish the message.

    requestDirective(self, subject, directiveString, fields, timeout, cb, republish_ms=0)
    ...
    fields: a list of and supplemental fields that the user wishes to include
    ...
    message. This message must be released with release(msg). This function
...
%feature("docstring") gmsec::api::mist::ConnectionManager::createHeartbeatMessage "
    ...
    Parameters
    ----------
    subject: the topic (subject) that will be applied to the returned messages.
    ...
    Exceptions
    ----------
    Exception is thrown if the subject is NULL.
...
%feature("docstring") gmsec::api::mist::ConnectionManager::publish "
    ...
    ----------
    An Exception is thrown if the ConnectionManager has not been initialized.
    An Exception is thrown if the message fails validation, or if any other severe
...
%feature("docstring") gmsec::api::mist::ConnectionManager::changeCPUMemory "
    ...
    Parameters
    ----------
    cpuMemory: Field containing updated information for the Heartbeat Message
...
%feature("docstring") gmsec::api::mist::ConnectionManager::acknowledgeSimpleService "
    ...
    ssResponse: an enumeration specifying the response code to the simple service
        request.
    fields: supplemental information fields which may be included with the message
...
%feature("docstring") gmsec::api::mist::ConnectionManager::startResourceMessageService "
    ...
    intervalSeconds: This the interval, in seconds, where messages are published to the bus.
    sampleInterval: This is the the time distance between samples (in seconds).
...
%feature("docstring") gmsec::api::mist::ConnectionManager::requestSimpleService "
    ...
    requestSimpleService(self, subject, opName, opNumber, fields, sParams)
    ...
    fields: a list of and supplemental fields that the user wishes to include
        with the directive message.
    sParams: a list of the ServiceParam objects providing meta data for this service
        invocation
    ...
    requestSimpleService(self, subject, opName, opNumber, fields, sParams, timeout, cb, republish_ms=0)
    ...
    requestSimpleService(self, subject, opName, opNumber, fields, sParams, timeout, republish_ms=0) -> Message
    ...
    This function then invokes request(request, timeout, republish_ms = 0)
    ...
    subject: subject on which to publish the message
    opName: the name of the operation of the service
    opNumber: the operation number for the service message is intended to convey
    fields: a list of and supplemental fields that the user wishes to include
        with the directive message.
    sParams: a list of the ServiceParam objects providing meta data for this service
        invocation
...
%feature("docstring") gmsec::api::mist::ConnectionManager::createResourceMessage "
    ...
    createResourceMessage(self, subject, sampleInterval=1, averageInterval=10)-> Message
...
%feature("docstring") gmsec::api::mist::ConnectionManager::subscribe "
    ...
    ----------
    An Exception is thrown if the ConnectionManager has not been initialized.
    An Exception is thrown if the subject string is NULL.

    subscribe(self, subject, config, cb=None) -> SubscriptionInfo

    This method subscribes to a particular subject or pattern and uses the provided config object
...
%feature("docstring") gmsec::api::mist::ConnectionManager::request "
    ...
    ----------
    An Exception is thrown if the ConnectionManager has not been initialized.
    An Exception is thrown if the request message fails validation, or if any other severe
...
%feature("docstring") gmsec::api::mist::ConnectionManager::acknowledgeDirectiveRequest "
    ...
    acknowledgeDirectiveRequest(self, subject, request, ssResponse, fields)
    ...
    subject: subject on which to publish the message
    request: the original directive message
    ssResponse: an enumeration specifying the response code to the directive
        request.
    fields: supplemental information fields which may be included with the message

    Exceptions
    ----------
    Exception is thrown if the ConnectionManager has not been initialized.
    An Exception is thrown if the message cannot be validated, or if other severe error
    occurs while attempting to publish the message.
";
...
%feature("docstring") gmsec::api::mist::ConnectionManager::cancelRequest "
    ...
    Parameters
    ----------
    cb: The ConnectionManagerReplyCallback to disassociate from a pending request.
...
%feature("docstring") gmsec::api::mist::ConnectionManager::stopResourceMessageService "
    ...
    Returns
    -------
    Returns true if the resource message service was running before invocation of this
...
%feature("docstring") gmsec::api::mist::ConnectionManager::setStandardFields "
    ...
    Sets the internal list of fields
    ...
    Parameters
    ----------
    standardFields: A list of fields to be copied to the internal set of fields, which
...
%feature("docstring") gmsec::api::mist::ConnectionManager::publishResourceMessage "
    ...
    ----------
    An Exception is thrown if the ConnectionManager has not been initialized.
    An Exception is thrown if a severe error occurs while attempting to
        publish the message.
";
...
%feature("docstring") gmsec::api::mist::ConnectionManager::publishLog "
    ...
    ----------
    An Exception is thrown if the ConnectionManager has not been initialized.
    An Exception is thrown if the Log Message cannot be validated, or if other severe error
        occurs while attempting to publish the message.
...
%feature("docstring") gmsec::api::mist::ConnectionManager::changeCPUUtil "
    ...
    Parameters
    ----------
    cpuUtil: Field containing updated information for the Heartbeat Message
...
%feature("docstring") gmsec::api::mist::ConnectionManager::release "
    ...
    This function destroys a message and cleans up any associated memory.
...
%feature("docstring") gmsec::api::mist::ConnectionManager::unsubscribe "
    ...
    ----------
    An Exception is thrown if the ConnectionManager has not been initialized.
    An Exception is thrown if the subject string is NULL, or if the callback that
...
%feature("docstring") gmsec::api::mist::ConnectionManager::cleanup "
    ...
    This function disconnects and destroys the
...
%feature("docstring") gmsec::api::mist::ConnectionManager::startHeartbeatService "
    ...
    heartbeatFields: list of fields to be added to the published heartbeat messages

    Exceptions
    ----------
    An Exception is thrown if the subject is NULL.
