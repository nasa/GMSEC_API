...
"        <type> value must be zeromq413 or zeromq432 [required]",

"        Used to specify the type of connection object to set up. For ZeroMQ\n"
"        clients, this must be set to either zeromq413 or zeromq432.\n",
...
"                mw-sub-endpoint=bind:tcp://10.10.50.123:4501\n"
"            \n"
