...
class GmsecConfigEdit : public gmsec::api5::util::Utility
{
public:
	GmsecConfigEdit(const gmsec::api5::Config& config);
...
private:
	...
	bool addSubscriptionEntry();
	bool removeSubscriptionEntry();
	...
	gmsec::api5::ConfigFile* m_configFile;
	Menu                     m_menuItems;
