...
int main(int argc, char** argv)
{
	...
	// Initialize log level log level
		...
		if (reqMsg)
		{
			...
			if (reqMsg->hasField("RESPONSE") && reqMsg->getBooleanValue("RESPONSE"))
			{
				...
				for (int i = 0; i < 4; ++i)
				{
					...
					{
					case 0:
						responseStatus = static_cast<GMSEC_I32>(Message::ResponseStatus::ACKNOWLEDGEMENT);
						break;
					case 3:
						responseStatus = static_cast<GMSEC_I32>(Message::ResponseStatus::SUCCESSFUL_COMPLETION);
						break;
					default:
						responseStatus = static_cast<GMSEC_I32>(Message::ResponseStatus::WORKING_KEEP_ALIVE);
						break;
					}
