...
class product_message
{
	...
	static int Main(string[] args)
	{
		...
		try
		{
			using (ConnectionManager connManager = new ConnectionManager(config))
			{
				...
				// Manager
				using(ProductFileMessage productMessage = new ProductFileMessage(PROD_MESSAGE_SUBJECT, ResponseStatus.Response.SUCCESSFUL_COMPLETION, Message.MessageKind.PUBLISH, "AUTO", "DM", connManager.GetSpecification()))
				{
